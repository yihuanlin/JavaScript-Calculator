...
(function() {
    ...
    div.style.cssText = "all:initial;transparent;box-shadow:0 0 18px rgba(70,70,40,0.255);background-color:rgba(255,255,255,0.8);border-radius:50px;position:fixed;bottom:30px;left:40px;height:30px;z-index:9999;";
    ...
    input.addEventListener('input', function() {
        try {
            input.setAttribute('size', Math.max(input.value.length, 1));
